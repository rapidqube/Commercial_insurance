...
function consignmentdetail(params) {
    ...
    return Promise.resolve().then(() => {
        ...
        console.log("Consignment Details: " + JSON.stringify(ConsignmentDetails));
        ...
        var request = {
            ...
            fcn: 'consignmentDetail',
            args: [ConsignmentDetails.id, ConsignmentDetails.consignmentWeight,
                ConsignmentDetails.consignmentValue, ConsignmentDetails.policyName,
                ConsignmentDetails.sumInsured, ConsignmentDetails.premiumAmount,
                ConsignmentDetails.modeofTransport, ConsignmentDetails.packingMode,
                ConsignmentDetails.consignmentType, ConsignmentDetails.contractType,
                ConsignmentDetails.policyType, ConsignmentDetails.email,
                ConsignmentDetails.policyHolderName, ConsignmentDetails.userType,
                ConsignmentDetails.invoiceNo, ConsignmentDetails.policyNumber,
                ConsignmentDetails.policyIssueDate, ConsignmentDetails.policyEndDate,
                ConsignmentDetails.voyageStartDate, ConsignmentDetails.voyageEndDate
            ],
...
function notify_Claim(params) {
    ...
    return Promise.resolve().then(() => {
        ...
        var request = {
            ...
            chaincodeId: options.chaincode_id,
            fcn: 'notifyClaim',
            args: [ClaimDetails.policyno, ClaimDetails.claim_no, ClaimDetails.claim_title, ClaimDetails.claim_damagedetails],
            chainId: options.channel_id,
            txId: tx_id
        };
        return channel.sendTransactionProposal(request);
